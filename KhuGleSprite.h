...
public:
	...
	CKhuGleSprite(int nType, int nCollisionType, CKgLine lnLine, KgColor24 fgColor, bool bFill, int nSliceOrWidth = 100, int nLife = INT_MAX);
	~CKhuGleSprite();
